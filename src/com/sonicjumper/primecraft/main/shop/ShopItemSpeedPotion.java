...
public class ShopItemSpeedPotion extends ShopItemPositivePotion {
	public ShopItemSpeedPotion(int itemId, String itemName, String displayName, UpgradePath path, ItemType type, Material itemMat, boolean multiBuy, int itemCost, int itemTier) {
	...
	public boolean setupSpecialRequirements(PlayerProfile pp) {
		requiredTier = (pp.getMaxPositivePotionCount(this) * 3) + 1;
	...
	public PotionEffect[] getPotionEffectsForTier(int tier) {
		return new PotionEffect[]{new PotionEffect(PotionEffectType.SPEED, ((tier * 10) + 5) * 20, 0)};
	}
